...
import { getTemplates, addSupportFunctionRemarks } from "../../store/templates";
...
export default function EditSupportRemarks({ open, id, successIndicator }) {
  ...
  const handleDelete = () => {
    dispatch(
      addSupportFunctionRemarks({ currentId: id, funcId, succId, remarks: "" })
    );
    return open(false);
  };
